...
final $typed_data.Uint8List endpointDescriptor = $convert.base64Decode('CghFbmRwb2ludBIYCgdhZGRyZXNzGAEgASgMUgdhZGRyZXNzEhIKBHBvcnQYAiABKAVSBHBvcnQSFgoGbm9kZUlkGAMgASgMUgZub2RlSWQ=');
...
final $typed_data.Uint8List pingMessageDescriptor = $convert.base64Decode('CgtQaW5nTWVzc2FnZRImCgRmcm9tGAEgASgLMhIucHJvdG9jb2wuRW5kcG9pbnRSBGZyb20SIgoCdG8YAiABKAsyEi5wcm90b2NvbC5FbmRwb2ludFICdG8SGAoHdmVyc2lvbhgDIAEoBVIHdmVyc2lvbhIcCgl0aW1lc3RhbXAYBCABKANSCXRpbWVzdGFtcA==');
...
final $typed_data.Uint8List pongMessageDescriptor = $convert.base64Decode('CgtQb25nTWVzc2FnZRImCgRmcm9tGAEgASgLMhIucHJvdG9jb2wuRW5kcG9pbnRSBGZyb20SEgoEZWNobxgCIAEoBVIEZWNobxIcCgl0aW1lc3RhbXAYAyABKANSCXRpbWVzdGFtcA==');
...
final $typed_data.Uint8List findNeighboursDescriptor = $convert.base64Decode('Cg5GaW5kTmVpZ2hib3VycxImCgRmcm9tGAEgASgLMhIucHJvdG9jb2wuRW5kcG9pbnRSBGZyb20SGgoIdGFyZ2V0SWQYAiABKAxSCHRhcmdldElkEhwKCXRpbWVzdGFtcBgDIAEoA1IJdGltZXN0YW1w');
...
final $typed_data.Uint8List neighboursDescriptor = $convert.base64Decode('CgpOZWlnaGJvdXJzEiYKBGZyb20YASABKAsyEi5wcm90b2NvbC5FbmRwb2ludFIEZnJvbRIyCgpuZWlnaGJvdXJzGAIgAygLMhIucHJvdG9jb2wuRW5kcG9pbnRSCm5laWdoYm91cnMSHAoJdGltZXN0YW1wGAMgASgDUgl0aW1lc3RhbXA=');
...
final $typed_data.Uint8List backupMessageDescriptor = $convert.base64Decode('Cg1CYWNrdXBNZXNzYWdlEhIKBGZsYWcYASABKAhSBGZsYWcSGgoIcHJpb3JpdHkYAiABKAVSCHByaW9yaXR5');
