...
class AccountCreateContract extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AccountCreateContract', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protocol'), createEmptyInstance: create)
    ...
    ..e<$0.AccountType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $0.AccountType.Normal, valueOf: $0.AccountType.valueOf, enumValues: $0.AccountType.values)
...
class AccountPermissionUpdateContract extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AccountPermissionUpdateContract', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protocol'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ownerAddress', $pb.PbFieldType.OY)
    ..aOM<$0.Permission>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'owner', subBuilder: $0.Permission.create)
    ..aOM<$0.Permission>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'witness', subBuilder: $0.Permission.create)
    ..pc<$0.Permission>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'actives', $pb.PbFieldType.PM, subBuilder: $0.Permission.create)
    ..hasRequiredFields = false
  ;
