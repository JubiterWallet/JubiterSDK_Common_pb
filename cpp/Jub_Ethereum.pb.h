...
class TransactionETH :
 ...
 public:
  ...
  private:
  const std::string& _internal_gas_price_in_wei() const;
  void _internal_set_gas_price_in_wei(const std::string& value);
  std::string* _internal_mutable_gas_price_in_wei();
  public:
  ...
  private:
  const std::string& _internal_value_in_wei() const;
  void _internal_set_value_in_wei(const std::string& value);
  std::string* _internal_mutable_value_in_wei();
  public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::uint32 _internal_gas_limit() const;
  void _internal_set_gas_limit(::PROTOBUF_NAMESPACE_ID::uint32 value);
  public:
...
inline const std::string& ContextCfgETH::_internal_main_path() const {
  return main_path_.GetNoArena();
}
inline void ContextCfgETH::_internal_set_main_path(const std::string& value) {
...
inline std::string* ContextCfgETH::_internal_mutable_main_path() {
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 ContextCfgETH::_internal_chain_id() const {
  return chain_id_;
}
...
inline void ContextCfgETH::_internal_set_chain_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
...
// .JUB.Proto.Common.Bip44Path path = 1;
inline bool TransactionETH::_internal_has_path() const {
  return this != internal_default_instance() && path_ != nullptr;
}
inline bool TransactionETH::has_path() const {
  return _internal_has_path();
}
inline const ::JUB::Proto::Common::Bip44Path& TransactionETH::_internal_path() const {
...
inline ::JUB::Proto::Common::Bip44Path* TransactionETH::_internal_mutable_path() {
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 TransactionETH::_internal_nonce() const {
  return nonce_;
}
...
inline void TransactionETH::_internal_set_nonce(::PROTOBUF_NAMESPACE_ID::uint32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 TransactionETH::_internal_gas_limit() const {
  return gas_limit_;
}
...
inline void TransactionETH::_internal_set_gas_limit(::PROTOBUF_NAMESPACE_ID::uint32 value) {
...
inline std::string* TransactionETH::mutable_gas_price_in_wei() {
  ...
  return _internal_mutable_gas_price_in_wei();
}
inline const std::string& TransactionETH::_internal_gas_price_in_wei() const {
  return gas_price_in_wei_.GetNoArena();
}
inline void TransactionETH::_internal_set_gas_price_in_wei(const std::string& value) {
...
inline std::string* TransactionETH::_internal_mutable_gas_price_in_wei() {
...
inline const std::string& TransactionETH::_internal_to() const {
  return to_.GetNoArena();
}
inline void TransactionETH::_internal_set_to(const std::string& value) {
...
inline std::string* TransactionETH::_internal_mutable_to() {
...
inline std::string* TransactionETH::mutable_value_in_wei() {
  ...
  return _internal_mutable_value_in_wei();
}
inline const std::string& TransactionETH::_internal_value_in_wei() const {
  return value_in_wei_.GetNoArena();
}
inline void TransactionETH::_internal_set_value_in_wei(const std::string& value) {
...
inline std::string* TransactionETH::_internal_mutable_value_in_wei() {
...
inline const std::string& TransactionETH::_internal_input() const {
  return input_.GetNoArena();
}
inline void TransactionETH::_internal_set_input(const std::string& value) {
...
inline std::string* TransactionETH::_internal_mutable_input() {
