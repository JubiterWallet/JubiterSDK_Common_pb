...
extension JUB_Proto_Ethereum_TransactionETH: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularUInt32Field(value: &self.nonce)
      case 3: try decoder.decodeSingularUInt32Field(value: &self.gasLimit)
      case 4: try decoder.decodeSingularStringField(value: &self.gasPriceInWei)
      case 5: try decoder.decodeSingularStringField(value: &self.to)
      case 6: try decoder.decodeSingularStringField(value: &self.valueInWei)
