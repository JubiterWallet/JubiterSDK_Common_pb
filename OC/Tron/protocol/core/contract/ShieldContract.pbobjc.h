 ...
 **/
@interface ShieldContractRoot : GPBRootObject
@end
...
@interface AuthenticationPath : GPBMessage
...
@interface MerklePath : GPBMessage
...
@interface OutputPoint : GPBMessage
...
@interface OutputPointInfo : GPBMessage
...
@interface PedersenHash : GPBMessage
...
@interface IncrementalMerkleTree : GPBMessage
...
@interface IncrementalMerkleVoucher : GPBMessage
...
@interface IncrementalMerkleVoucherInfo : GPBMessage
...
@interface SpendDescription : GPBMessage
...
@interface ReceiveDescription : GPBMessage
...
@interface ShieldedTransferContract : GPBMessage
