...
#import "core/contract/ShieldContract.pbobjc.h"
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        ...
        .dataTypeSpecific.className = GPBStringifySymbol(AuthenticationPath),
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "outPointsArray",
        .dataTypeSpecific.className = GPBStringifySymbol(OutputPoint),
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "left",
        .dataTypeSpecific.className = GPBStringifySymbol(PedersenHash),
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "tree",
        .dataTypeSpecific.className = GPBStringifySymbol(IncrementalMerkleTree),
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "vouchersArray",
        .dataTypeSpecific.className = GPBStringifySymbol(IncrementalMerkleVoucher),
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        ...
        .dataTypeSpecific.className = GPBStringifySymbol(SpendDescription),
      ...
      },
      {
        ...
        .dataTypeSpecific.className = GPBStringifySymbol(ReceiveDescription),
